...
⚙️ I enjoy designing secure and optimized systems — from database structuring with PostgreSQL/MySQL to implementing authentication, API integrations, and clean architecture principles. My goal is to write code that is not just functional, but maintainable and production-ready.

🛠 I’ve worked on projects like:

🔗 URL Shortener (Spring Boot + JPA + PostgreSQL)
...
<!--
**Saniya1030/Saniya1030** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
